defmodule PrimeTimeTest do
  ...
  test "server prime number calculation requirements" do
    assert PrimeTime.is_prime?(-4) == false
    assert PrimeTime.is_prime?(-3) == false
    assert PrimeTime.is_prime?(-2) == false
    assert PrimeTime.is_prime?(-1) == false
    assert PrimeTime.is_prime?(0) == false
    assert PrimeTime.is_prime?(1) == false
    assert PrimeTime.is_prime?(2) == true
    assert PrimeTime.is_prime?(3) == true
    assert PrimeTime.is_prime?(4) == false
  end
